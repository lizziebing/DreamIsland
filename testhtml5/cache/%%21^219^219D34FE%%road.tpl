129
a:4:{s:8:"template";a:1:{s:8:"road.tpl";b:1;}s:9:"timestamp";i:1422337983;s:7:"expires";i:1422424383;s:13:"cache_serials";a:0:{}}<!DOCTYPE HTML>
<html>
<head>
...
//}
//function ref(){
////	$.ajax({ url: "http://plug/do_ajax_add", 
...
<h1>系统时间：</h1>-->
    ...
    <div style="padding:2px 0px 0px 5px;font-size:12px;height:40px"> 
        ...
        <input id="query" value="到指定的城市" type="button" onClick="javascript:setCity()"/>
